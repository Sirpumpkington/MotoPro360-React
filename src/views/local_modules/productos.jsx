...
export default function Productos({
  ...
  onRefresh,                  // <-- NUEVA PROP: función para recargar productos desde el padre
}) {
  const [vista, setVista] = useState("grid");
  const [filtroEstado, setFiltroEstado] = useState("todos");
  const [mostrandoEstadisticas, setMostrandoEstadisticas] = useState(false);

  // Estados para descuento (dentro del formulario)
  ...
  const handleCardClick = (producto) => {
    ...
    // Si el producto tiene una promoción activa, cargar sus datos
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await guardarProducto({ descuento, fechaExpiracion });
      ...
      {!creandoProducto ? (
        ...
        <div className={styles.productForm}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* SECCIÓN DE OFERTA */}
            <h3 className={styles.sectionTitle}>Oferta (opcional)</h3>
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
